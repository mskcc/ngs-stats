...
public class WgsMetrics {
    ...
    public Double PCT_EXC_ADAPTER;  // allow null since it was not in Picard 2.9
    ...
    /**
     * The fraction of aligned bases that were filtered out because they were the second observation from an insert
     * with overlapping reads.
     */
    public double PCT_EXC_OVERLAP;
    /**
     * The fraction of aligned bases that were filtered out because they would have raised coverage above the capped
     * value (default cap = 250x).
     */
