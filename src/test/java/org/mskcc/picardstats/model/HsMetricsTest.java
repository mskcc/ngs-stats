...
class HsMetricsTest {
    ...
    void readFileMissingRequiredValue() throws FileNotFoundException, IllegalAccessException {
        ...
        HsMetrics hs = HsMetrics.readFile(f, "3"); // required double FOLD_80_BASE_PENALTY has infrequent valid value "?"
        assertNotNull(hs);
    }
    ...
    void readFileFileWithAnotherQuestionMark() throws FileNotFoundException, IllegalAccessException {
        ...
        HsMetrics hs = HsMetrics.readFile(f, "3"); // required double FOLD_80_BASE_PENALTY has value "?"
        assertNotNull(hs);
    }
