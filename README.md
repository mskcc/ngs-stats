A Java/JPA, Tomcat & MySQL application initiated in 2018 running on delphi.mskcc.org which has 17 tables with IGO (Integrated Genomics Operation) post sequencing information such as:
